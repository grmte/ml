...
print ("Reading in fRatioOfBidQSumAskQSumOfCurrentLess1Row.feature") 
feature23=read.csv(paste(args[2],"fRatioOfBidQSumAskQSumOfCurrentLess1Row.feature",sep=""), header=FALSE) 
...
if (length(feature22$V1) != length(feature23$V1)) { 
print ("The feature lengths do not match for feature22fRatioOfBidQSumAskQSumOfCurrentRow and feature23fRatioOfBidQSumAskQSumOfCurrentLess1Row") 
quit() 
}else{ 
print ("Length of feature22 is same as length of feature23")
}
