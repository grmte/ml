    ...
    if(pEnterTradeShort == -1): # Need to buy we come here only if currentPosition is greater than 0 so no need to check again.
        ...
        if spreadAtTimeOfPreviousDataRow > gTickSize:        
            if(l_dummy_TTQChange_For_Buy<=0):
                ...
                gCloseBuyPrice = (pBidP0AtTimeOfPreviousDataRow + gTickSize)
        ...
        #hitting
            ...
            if l_buy_qty > 0:
                ...
                gCloseBuyPrice = pAskP0AtTimeOfPreviousDataRow
            else :
    ...
    if(pEnterTradeLong == 1 and ( gMaxQty - pTradeStats['currentPositionLong'] ) > 0): # Need to buy
        ...
        if spreadAtTimeOfPreviousDataRow > gTickSize:        
            if(l_dummy_TTQChange_For_Buy <= 0 ):
                ...
                gOpenBuyPrice =  (pBidP0AtTimeOfPreviousDataRow + gTickSize)
        ...
        #hitting
            ...
            if l_dummy_AskQ0 > 0 :
                ...
                gOpenBuyPrice =  pAskP0AtTimeOfPreviousDataRow
            else:
    ...
    if(pEnterTradeLong == -1): # Need to sell we come here only if currentPosition is greater than 0 so no need to check again.
        ...
        if spreadAtTimeOfPreviousDataRow > gTickSize:        
            if(l_dummy_TTQChange_For_Sell <= 0 ):
                ...
                gCloseSellPrice = pAskP0AtTimeOfPreviousDataRow - gTickSize
        ...
        #hitting
            ...
            if lQtyTraded > 0 :
                ...
                gCloseSellPrice = pBidP0AtTimeOfPreviousDataRow
            else :
    ...
    if(pEnterTradeShort == 1 and  ( gMaxQty - pTradeStats['currentPositionShort'] ) > 0 ): # Need to sell
        ...
        if spreadAtTimeOfPreviousDataRow > gTickSize:        
            if(l_dummy_TTQChange_For_Sell <= 0):
                ...
                gOpenSellPrice = (pAskP0AtTimeOfPreviousDataRow - gTickSize)
        ...
        #hitting
            ...
            if l_dummy_BidQ0 > 0 :
                ...
                gOpenSellPrice = pBidP0AtTimeOfPreviousDataRow
                pReasonForTrade['OpenSellTradeHappened'] += lQtyForWhichWeTrade
...
if __name__ == "__main__":
    ...
    fileName = lWFDirName + "/r/" + mainExperimentName + "/" + initialFileName+".targetResult"
