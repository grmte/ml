...
for indexOfCL in range(0,len(gEntryCLList)):
    lInitialFileName = args.a + '-td.' + os.path.basename(os.path.abspath(args.td)) + \
                   ...
                   '-l.'+gEntryCLList[indexOfCL]+"-"+gExitCLList[indexOfCL] + "-" +gEntryCL2List[indexOfCL]+"-"+gExitCL2List[indexOfCL] + "-tq." + args.orderQty + "-te.7WithMultiPredOtherSideProb"
...
#                pdb.set_trace()
            ...
            if(lOpenSell > 0 and (lCurrentSellPredictedValue[lOpenSell-1] < lCancelCLOpen[lOpenSell-1]) or (lCurrentBuyPredictedValue[0] > lCancelCL2Open)) or tradeStats['currentPositionShort'] == gMaxQty:
                lOpenSell = 0
            ...
            if(lOpenBuy > 0 and (lCurrentBuyPredictedValue[lOpenBuy-1] < lCancelCLOpen[lOpenBuy-1] or lCurrentSellPredictedValue[0] > lCancelCL2Open)) or tradeStats['currentPositionLong'] == gMaxQty:
                lOpenBuy = 0
