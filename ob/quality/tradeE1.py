...
def main():
   ...
   fileName = tradeResultSubDirectoryName+experimentName+args.a+args.entryCL+"-"+args.exitCL+"E1.result" 
...
if __name__ == "__main__":
   dirName = args.d.replace('/ro/','/rs/')
   fileName = dirName + "/r/" + mainExperimentName + "/" + experimentName+args.a+args.entryCL+"-"+args.exitCL+"E1.result"
