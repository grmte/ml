...
X <- cbind(feature1$V2,feature2$V2)
logistic.fit <- glmnet (x = X, y = targetVector$V2)

print (paste("Section8: Saving the model in file ob/e8/glmnet.model")) 
save(logistic.fit, file = "ob/e8/glmnet.model")