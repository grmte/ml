...
fit <- glm (tBidEqualToAskInNext100 ~  , data = df,family = binomial(link="logit") ) 

print (paste("Section8: Saving the model in file ob/e7/logitr.model")) 
save(fit, file = "ob/e7/logitr.model")