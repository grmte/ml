...
fileName = paste(args[2],"e7logitr.predictions",sep="") 
...
print ("Section11: Saving the predictions in file e7logitr.predictions") 
fileName = paste(args[2],"e7logitr.predictions",sep="") 
print (fileName) 
