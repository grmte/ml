...
fileName = paste(args[2],"e8logitr.predictions",sep="") 
...
load("ob/e8//logitr.model")

print ("Section7: Creating the data frame") 
df = data.frame(fBidP0OfCurrentRow=feature1$V2,fBidP1OfCurrentRow=feature2$V2)
...
print ("Section11: Saving the predictions in file e8logitr.predictions") 
fileName = paste(args[2],"e8logitr.predictions",sep="") 
print (fileName) 
