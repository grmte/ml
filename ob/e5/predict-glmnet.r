...
fileName = paste(args[2],"e5glmnet.predictions",sep="") 
...
load("ob/e5//glmnet.model")

print ("Section7: Creating the data frame") 
df = cbind(feature1$V2,feature2$V2,feature3$V2,feature4$V2,feature5$V2,feature6$V2,feature7$V2,feature8$V2,feature9$V2,feature10$V2,feature11$V2,feature12$V2,feature13$V2,feature14$V2,feature15$V2,feature16$V2,feature17$V2,feature18$V2,feature19$V2,feature20$V2,feature21$V2,feature22$V2)

print ("Section8: Running glmnet prediction") 
df$Prob <- predict (fit, newx = df)
...
print ("Section11: Saving the predictions in file e5glmnet.predictions") 
fileName = paste(args[2],"e5glmnet.predictions",sep="") 
print (fileName) 
