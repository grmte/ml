...
def extractAttributeFromDataMatrix(args):
    ...
    lBPL = [ colNumberOfData.BidP1 , colNumberOfData.BidP2 , colNumberOfData.BidP3 , colNumberOfData.BidP4 , colNumberOfData.BidP5  ]
    lBQL = [ colNumberOfData.BidQ1 , colNumberOfData.BidQ2 , colNumberOfData.BidQ3 , colNumberOfData.BidQ4 , colNumberOfData.BidQ5   ]
