...
def extractAttributeFromDataMatrix():
   ...
   for dataRow in dataFile.matrix:
      ...
      if (currentRowCount == 0 or currentRowCount == 1):
         attribute.list[currentRowCount][0] = common.getTimeStamp(dataFile.matrix[currentRowCount])
         attribute.list[currentRowCount][1] = 0 # TODO: Figure out how to put NA here.
      ...
      attribute.list[currentRowCount][0] = common.getTimeStamp(dataFile.matrix[currentRowCount])
      attribute.list[currentRowCount][1] = float(BidQSum)/AskQSum
