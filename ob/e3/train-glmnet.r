...
X <- cbind(feature1$V2,feature2$V2,feature3$V2,feature4$V2,feature5$V2,feature6$V2,feature7$V2,feature8$V2,feature9$V2,feature10$V2,feature11$V2,feature12$V2,feature13$V2,feature14$V2,feature15$V2,feature16$V2,feature17$V2,feature18$V2,feature19$V2,feature20$V2,feature21$V2)
fit <- glmnet (x = X, y = targetVector$V2)

print (paste("Section8: Saving the model in file ob/e3/glmnet.model")) 
save(fit, file = "ob/e3/glmnet.model")