...
fileName = paste(args[2],"e4.predictions",sep="") 
...
load("./ob/e4//design.model")

print ("Section7: Creating the data frame") 
df = data.frame(fRatioOfBidQSumAskQSum=feature1$V2,fRatioOfBidAskQ0OfCurrentRow=feature2$V2)
...
print ("Section11: Saving the predictions in file e4.predictions") 
fileName = paste(args[2],"e4.predictions",sep="") 
print (fileName) 
