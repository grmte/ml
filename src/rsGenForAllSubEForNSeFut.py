...
utility.runCommand(["accumulate_results.py","-e",args.e,"-a",algo,"-t",args.t,"-td",args.td, "-dt" , str(args.dt) , '-nD' , str(args.nD) , "-m" ,"NseFUT RELIANCE WithABCDE for all Qty"+args.pd+"\n" , "-f" , "1","-iT",args.iT,"-oT",args.oT,"-sP",args.sP],args.run,args.sequence)
if(args.sequence == "dp"):
    print dp.printGroupStatus()
